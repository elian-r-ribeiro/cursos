...
export default function CadastroUsuario() {
    ...
    return (
        ...
        <div className="flex flex-col gap-5">
            ...
            {usuarioAtual ? <FormUsuario cancelar={cancelar} usuario={usuarioAtual} alterarUsuario={setUsuarioAtual} salvar={salvarUsuario} /> :
                <ListaUsuarios usuarios={usuarios} removerUsuario={removerUsuario} selecionarUsuario={selecionarUsuario}></ListaUsuarios>}
        </div>
    );
}